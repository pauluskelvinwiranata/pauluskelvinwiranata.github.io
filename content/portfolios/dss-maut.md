...
- 📝 **CRUD Criteria:** Manage the criteria used in the decision-making process, including adding, modifying, deleting, and viewing criteria.
...
- ⚙️ **Calculation Process:** Perform decision calculations using the MAUT method to determine the best alternative.
...
- ✏️ **Edit Profile:** Allows administrators to update their profile information.
...
- ⚙️ **Calculation Process:** Perform decision calculations using the MAUT method to assist users in decision-making.
- 🖨️ **Print Calculation Results:** Print the calculation results for further reference or documentation.
- ✏️ **Edit Profile:** Allows users to update their profile information.
- 🚪 **Log Out:** Securely log out of the system after completing tasks.
